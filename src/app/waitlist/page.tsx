...
export const metadata: Metadata = {
  title: 'Path by HI Waitlist',
  description: "Be the first to know when Path by HI launches. Drop your email and we'll let you know when it's ready.",
}
        ...
        <section className="section-pad" style={{ background: 'var(--navy)' }}>
          <div className="container" style={{ maxWidth: '560px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 'clamp(15px, 2.5vw, 17px)', color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, fontWeight: 300, margin: 0 }}>
              We&apos;re putting the finishing touches on Path by HI. Drop your email and we&apos;ll let you know when it&apos;s ready.
            </p>
          </div>
        </section>
