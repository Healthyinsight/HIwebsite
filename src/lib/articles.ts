...
const articleSeeds: ArticleMeta[] = [
  ...
  },
  {
    ...
    excerpt: 'A complete, research-backed guide to race day nutrition for endurance athletes: how to carb load, what to eat for breakfast, and how to fuel mid-race.',
    pillar: 'nutrition',
    format: 'guide',
    level: 2,
    readingTime: '7 min',
    ...
    evidenceStrength: 'strong',
    evidenceNote: 'Carbohydrate dose-response for endurance events is well-established across multiple reviews and position stands; the race-day under-consumption gap is consistently observed but rests on fewer studies.',
    tldr: [
  ...
  {
    slug: 'vo2-max-4x4-intervals-evidence-based-protocol',
    title: 'VO₂ Max with 4×4 Intervals: The Evidence-Based Protocol',
    excerpt: 'The most researched protocol for raising your aerobic ceiling. How 4-minute intervals at 90–95% max HR force cardiac adaptation and why the duration is critical.',
    pillar: 'motion',
    format: 'protocol',
    level: 3,
    readingTime: '10 min',
  ...
  {
    slug: 'progressive-overload-science-based-methods',
    title: 'The Complete Guide to Progressive Overload: Science-Based Methods',
    excerpt: 'The fundamental law of physical adaptation. How to systematically increase load, reps, and volume to keep making progress without hitting a plateau.',
    pillar: 'motion',
    format: 'guide',
    level: 2,
    readingTime: '10 min',
  ...
  {
    slug: 'group-training-run-clubs-science',
    title: 'The Science of Group Training: Why Run Clubs Make You Faster',
    excerpt: 'Social facilitation is a proven physiological phenomenon. Running with others lowers your RPE and lets you run faster at the same perceived effort.',
    pillar: 'motion',
    format: 'review',
    level: 2,
    readingTime: '9 min',
